...
function moveCupboard(){
    ...
    $ready_to_work = !$is_hungry && !$wearing_glasses && $wearing_contacts && !$needs_to_pee;
    ...
    if($location !== 'kitchen'){
        ...
        echo "You're not ready to work! You need to properly fed, have an empty bladder, and have corrected there's no point in even trying to move the cupboard.\n";
    } else {
